...
- Backend Render service: `NODE_ENV=production`, `FRONTEND_ORIGINS=https://oral-health-app-frontend.onrender.com`, `MONGO_URI`, `MONGO_DB_NAME=oral-health-app`, `JWT_SECRET`, and Firebase Admin credentials
